...
namespace PetClinic.Controllers
{
    public class AppointmentsController : Controller
    {
        ...
        {
            ViewBag.ClientID = new SelectList(db.Clients, "ClientID", "ClientsName");
        ...
        public ActionResult Create([Bind(Include = "AppointmentID,AppointmentDate,DoctorID,ClientID,RoomID")] Appointment appointment)
        {
            ...
            ViewBag.ClientID = new SelectList(db.Clients, "ClientID", "ClientsName", appointment.ClientID);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AppointmentID,AppointmentDate,DoctorID,ClientID,RoomID")] Appointment appointment)
        {
            if (ModelState.IsValid)
            {
